...
def generate_launch_description():
    ...
    bringup_dir = get_package_share_directory('my_simulation')
    launch_dir = os.path.join(bringup_dir, 'launch')
    pkg_gazebo_ros = get_package_share_directory('gazebo_ros')

    # Xacro path
    urdf_dir = get_package_share_path('my_simulation') / 'urdf' / 'waking_robot.xacro'
    ...
    declare_world_cmd = DeclareLaunchArgument(
        'world',
        default_value=os.path.join(bringup_dir, 'world', 'fish.world'),
